## simple_actions (foxy) - 0.2.2-1

The packages in the `simple_actions` repository were released into the `foxy` distro by running `/usr/bin/bloom-release -r foxy simple_actions` on `Wed, 29 Mar 2023 15:58:49 -0000`
